...
/*--99 --*/  { "color of the sun",                              "yellow",     "yelow",      "yello"      },
   ...
   { "The chef ____ a delicious meal.",                        "cooked",       "taught",       "slept"      },
    ...
    { "The photographer ____ pictures of the sunset.",          "took",         "fixed",        "read"       },
    { "The mechanic ____ the broken engine.",                   "fixed",        "read",         "drew"       },
    { "The student ____ for the upcoming exam.",                "read",         "drew",         "took"       },
    { "The artist ____ a portrait on the canvas.",              "drew",         "wagged",       "sang"       },
    { "The dog ____ its tail happily.",                         "wagged",       "sang",         "watered"    },
    { "The singer ____ in front of the audience.",              "sang",         "watered",      "wrote"      },
    { "The gardener ____ the flowers every morning.",           "watered",      "wrote",        "helped"     },
    { "The writer ____ a new short story.",                     "wrote",        "helped",       "drove"      },
    { "The doctor ____ the patient carefully.",                 "helped",       "drove",        "built"      },
    { "The driver ____ the car down the highway.",              "drove",        "built",        "served"     },
    { "The carpenter ____ a sturdy table.",                     "built",        "served",       "swam"       },
    { "The waiter ____ food to the customers.",                 "served",       "swam",         "cooked"     },
    { "The swimmer ____ laps in the pool.",                     "swam",         "cooked",       "taught"     },
    { "The farmer ____ the seeds in the soil.",                 "planted",      "milked",       "fed"        },
    { "The baker ____ a cake for the party.",                   "baked",        "planted",      "swept"      },
    { "The janitor ____ the dirty floor.",                      "swept",        "baked",        "rang"       },
    { "The bell ____ when the class ended.",                    "rang",         "swept",        "pushed"     },
    { "The man ____ the heavy box across the room.",            "pushed",       "rang",         "caught"     },
    { "The boy ____ the ball in the air.",                      "caught",       "pushed",       "spilled"    },
    { "The girl ____ the milk on the table.",                   "spilled",      "caught",       "carried"    },
    { "The father ____ his child to the park.",                 "took",         "spilled",      "called"     },
    { "The mother ____ her son for dinner.",                    "called",       "took",         "opened"     },
    { "The child ____ the door to go outside.",                 "opened",       "called",       "climbed"    },
    { "The monkey ____ up the tall tree.",                      "climbed",      "opened",       "jumped"     }
    };
...
/*--49 --*/  { "an African striped animal",                                 "zebra",         "zeebra",        "zebrah"        },
    ...
    {
    // Based on spelling pairs (15 entries)
    { "The swamp was home to a large ____.",                                "alligator",    "elephant",     "crocodile"  },
    { "The ship dropped its ____ to stay in place.",                       "anchor",       "chain",        "rope"       },
    { "The knight wore heavy ____ into battle.",                           "armor",        "helmet",       "shield"     },
    { "She peeled the yellow ____ for a snack.",                           "banana",       "apple",        "orange"     },
    { "She carried groceries in a woven ____.",                            "basket",       "bag",          "box"        },
    { "The town was buried in a fierce ____.",                             "blizzard",     "storm",        "rain"       },
    { "He drank water from a plastic ____.",                               "bottle",       "cup",          "glass"      },
    { "The driver crossed the old stone ____.",                            "bridge",       "road",         "tunnel"     },
    { "The king lived in a grand ____.",                                   "castle",       "palace",       "house"      },
    { "The mouse ate a piece of ____.",                                    "cheese",       "bread",        "cake"       },
    { "The child ate a sweet ____ bar.",                                   "chocolate",    "candy",        "cookie"     },
    { "The hiker used a ____ to find his way.",                            "compass",      "map",          "phone"      },
    { "She baked a fresh ____ for the party.",                             "cookie",       "brownie",      "muffin"     },
    { "The queen wore a golden ____ on her head.",                         "crown",        "necklace",     "ring"       },
    { "The traveler crossed the hot ____.",                                "desert",       "forest",       "mountain"   },
    
    // Regular sentences - harder but not too difficult (15 entries)
    { "The committee will ____ the final decision by Friday.",             "announce",     "delay",        "ignore"     },
    { "The mechanic ____ the engine after hours of troubleshooting.",      "repaired",     "inspected",    "dismantled" },
    { "The novelist ____ her latest manuscript to the publisher.",         "submitted",    "returned",     "withdrew"   },
    { "The pastry chef ____ the cake with edible flowers.",               "garnished",    "covered",      "mixed"      },
    { "The marathon runner ____ through the finish line exhausted.",       "staggered",    "jogged",       "skipped"    },
    { "The orchestra ____ the symphony to a standing ovation.",            "performed",    "rehearsed",    "composed"   },
    { "The farmer ____ the ripe wheat before the storm arrived.",          "harvested",    "watered",      "planted"    },
    { "The software team ____ the final version of the app.",              "launched",     "tested",       "canceled"   },
    { "The jury ____ the defendant after three days of deliberation.",     "acquitted",    "convicted",    "questioned" },
    { "The sculptor ____ a masterpiece from a block of marble.",           "carved",       "painted",      "drew"       },
    { "The audience ____ with laughter throughout the comedy show.",       "erupted",      "watched",      "sat"        },
    { "The captain ____ the ship through the narrow channel.",             "navigated",    "steered",      "abandoned"  },
    { "The veterinarian ____ the injured stray cat back to health.",       "nursed",       "examined",     "released"   },
    { "The ballerina ____ gracefully across the stage.",                   "glided",       "walked",       "fell"       },
    { "The archaeologist ____ ancient artifacts from the tomb.",           "unearthed",    "buried",       "purchased"  }
    };
...
/*--49 --*/  { "a stepped pyramid from ancient Mesopotamia",                   "ziggurat",      "zigurato",      "zigurat"       },
    ...
    {
    // Based on spelling pairs (15 entries)
    { "The zoo acquired a rare ____ with a long snout.",                    "aardvark",     "armadillo",    "anteater"      },
    { "The actors performed in an ancient Roman ____.",                    "amphitheater", "colosseum",    "stadium"       },
    { "The ____ curled into a ball to protect itself.",                    "armadillo",    "pangolin",     "porcupine"     },
    { "The ____ perched on the chandelier and mimicked the guests.",       "cockatoo",     "parrot",       "macaw"         },
    { "The castle's ____ was lowered to allow entry.",                     "drawbridge",   "portcullis",   "gate"          },
    { "The stone ____ glared down from the cathedral roof.",               "gargoyle",     "statue",       "sculpture"     },
    { "The ____ fought bravely in the arena.",                             "gladiator",    "warrior",      "soldier"       },
    { "The explorer used a ____ to hunt for whales.",                      "harpoon",      "spear",        "lance"         },
    { "Children gazed into the colorful ____.",                            "kaleidoscope", "telescope",    "microscope"    },
    { "Theseus entered the ____ to defeat the beast.",                     "labyrinth",    "maze",         "tunnel"        },
    { "The ____ performed a ritual to honor the gods.",                    "pharaoh",      "priest",       "king"          },
    { "The ____ waddled along the riverbank looking for food.",            "platypus",     "otter",        "beaver"        },
    { "The ancient ____ stood tall against the desert sky.",               "pyramid",      "temple",       "monument"      },
    { "The ____ wielded his katana with great skill.",                     "samurai",      "ninja",        "warrior"       },
    { "The ____ spun its web and waited for prey.",                        "tarantula",    "spider",       "scorpion"      },
    
    // Regular sentences - harder but not too difficult (15 entries)
    { "The historian ____ the ancient manuscript for hidden meanings.",    "deciphered",   "translated",   "copied"        },
    { "The alchemist attempted to ____ lead into gold.",                   "transform",    "discover",     "create"        },
    { "The explorer's ____ led him to discover a hidden civilization.",    "persistence",  "curiosity",    "ambition"      },
    { "The jury had to ____ between two conflicting testimonies.",         "discern",      "decide",       "choose"        },
    { "The artist's ____ style was instantly recognizable.",               "unique",       "strange",      "modern"        },
    { "The scientist made a ____ discovery that changed the field.",       "profound",     "simple",       "sudden"        },
    { "The general devised a ____ strategy to defeat the enemy.",          "cunning",      "simple",       "direct"        },
    { "The mountaineer faced ____ conditions near the summit.",            "treacherous",  "difficult",    "dangerous"     },
    { "The detective noticed a ____ detail that others overlooked.",       "subtle",       "obvious",      "minor"         },
    { "The philosopher's ideas were considered ____ for his time.",        "radical",      "strange",      "complex"       },
    { "The diplomat maintained a ____ expression during negotiations.",    "stoic",        "calm",         "serious"       },
    { "The crowd grew ____ as the concert was delayed.",                   "restless",     "angry",        "tired"         },
    { "The chef's ____ creation combined unexpected flavors.",             "culinary",     "artistic",     "creative"      },
    { "The hiker felt a sense of ____ when she reached the summit.",       "triumph",      "happiness",    "relief"        },
    { "The king ruled with ____ authority over his kingdom.",              "absolute",     "great",        "total"         }
    };
