...
public class MediumLetterContainerSpawner : MonoBehaviour
{
    [Header("References")]
    ...
    public float indicatorSpawnDistanceAhead = 30f;
    public float indicatorAnimationTime = 2f;
    public float indicatorStayTime = 5f;
    public float indicatorStartHeightOffset = 10f;
